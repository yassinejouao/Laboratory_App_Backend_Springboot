...
public class SampleServiceImpl implements ISampleService {
	...
	public SampleDTO addSampleService(SampleDTO s) throws NotFoundException {
		...
		System.out.println(optionalPatient.get().getStatus());
		if (optionalPatient.isPresent()){
			if(optionalPatient.get().getStatus().toString().equals("INACTIVE")) {
				throw new NotFoundException("Patient is inactive");
			}
